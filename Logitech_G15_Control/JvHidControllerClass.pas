...
Known Issues:
-----------------------------------------------------------------------------}
// $Id: JvHidControllerClass.pas 11138 2007-01-05 14:12:49Z marquardt $
...
const
  UnitVersioning: TUnitVersionInfo = (
    RCSfile: '$URL: https://svn.sourceforge.net:443/svnroot/jvcl/trunk/jvcl/run/JvHidControllerClass.pas $';
    Revision: '$Revision: 11138 $';
    Date: '$Date: 2007-01-05 15:12:49 +0100 (Fr, 05 Jan 2007) $';
    LogPath: 'JVCL\run'
  );
{$ENDIF UNITVERSIONING}
{$ENDIF USEJVCL}
